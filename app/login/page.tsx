    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-amber-700">Welcome back to your AI content assistant</p>
        </div>
        ...
        <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm border-orange-200/60">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-amber-700">Enter your credentials to access your dashboard</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 border-orange-200"
                  ...
                  <button
                    ...
                    className="absolute right-3 top-3 text-amber-600 hover:text-orange-700"
                  >
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 shadow-lg hover:shadow-xl"
              >
                Sign In
              </Button>
            </form>
            ...
            <div className="mt-6">
              ...
              <div className="text-center">
                <p className="text-sm text-amber-700">
                  ...
                  <Link href="/onboarding" className="text-orange-600 hover:text-orange-700 font-medium">
                    Sign up for free
                  </Link>
                </p>
              </div>
        ...
        <div className="mt-6 p-4 bg-orange-50 rounded-lg border border-orange-200">
          <h3 className="font-medium text-orange-900 mb-2">Demo Credentials</h3>
